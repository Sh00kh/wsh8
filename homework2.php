...
Quiz 2 Mark: <input type="number" name="q2" id="q2" placeholder="0" min="0" max="5" width="30" >
...
Final Exam Mark: <input type="number" name="fm" id="fm" placeholder="0" min="0">
    ...
    <input type= "submit"  value="Generate Report" name="submit" id="g">
    <input type="reset" value="Reset" name="Reset" id="r"><br>
		<br>
